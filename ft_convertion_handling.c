...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_convertion_handling.c                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: tnemangw <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/08/09 16:26:21 by tnemangw          #+#    #+#             */
/*   Updated: 2018/09/03 17:26:41 by tnemangw         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				ft_convertion_handling(char **fmt, va_list va)
{
	t_flist		lst;
	...
	while ((ft_strchr("+-#0 .123456789hljz", **fmt)))
	{
		(ft_strchr("#0-+ ", **fmt)) ? ft_flags(fmt, &lst) : 0;
		...
		(ft_strchr("hlzj", **fmt)) ? ft_modifier(fmt, &lst) : 0;
		(*fmt)++;
	}
